...
type BlogFileController struct {
	service services.BlogFileService
}

func (c *BlogFileController) Count(w http.ResponseWriter, r *http.Request) {
...
func (c *BlogFileController) GetAll(w http.ResponseWriter, r *http.Request) {
	// Retrieve query parameters
	search := r.URL.Query().Get("search")
...
func (c *BlogFileController) Create(w http.ResponseWriter, r *http.Request) {
...
func (c *BlogFileController) Update(w http.ResponseWriter, r *http.Request) {
	// Get JSON from user input
	input := models.BlogFile{}
	if err := json.NewDecoder(r.Body).Decode(&input); err != nil {
		render.Status(r, http.StatusBadRequest)
...
func (c *BlogFileController) Remove(w http.ResponseWriter, r *http.Request) {
